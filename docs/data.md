...
| Pool | Count | Path |
|---|---:|---|
| **SFT demos** | **6165** | `data/agentic_combined_v3to35/sft_demos.jsonl` |
...
Combined yield: **2593 pairs**. `v13 corruption-style` had 95% pair yield vs tournament-style's 34-41% (see `experiment.md` §3).
